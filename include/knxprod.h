...
#define paramDelay(time) (uint32_t)(                                                                                                               \
    (time & 0xC000) == 0xC000 ? (time & 0x3FFF) * 100 : (time & 0xC000) == 0x0000 ? (time & 0x3FFF) * 1000                                         \
                                                    : (time & 0xC000) == 0x4000   ? (time & 0x3FFF) * 60000                                        \
                                                    : (time & 0xC000) == 0x8000   ? ((time & 0x3FFF) > 1000 ? 3600000 : (time & 0x3FFF) * 3600000) \
                                                                                  : 0)

#define MAIN_OpenKnxId 0xA0
#define MAIN_ApplicationNumber 1
#define MAIN_ApplicationVersion 131
#define MAIN_ParameterSize 259
...
#define PM_ChannelCount 1

// Parameter per channel
#define PM_ParamBlockOffset 121
...
#define BASE_KommentarModuleParamOffset 259
