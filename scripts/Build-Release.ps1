...
lib/OGM-Common/setup-scripts/reusable/Build-Step.ps1 release_RP2040_devel firmware-DeveloperBoard uf2
if (!$?) { exit 1 }
...
lib/OGM-Common/setup-scripts/reusable/Build-Step.ps1 release_RealPresence firmware-RealPresence uf2
if (!$?) { exit 1 }
